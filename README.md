...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/cloudflareworker)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/cloudflareworker
```

A live public deployment of this template is available at [https://cloudflareworker.templates.workers.dev](https://cloudflareworker.templates.workers.dev)
